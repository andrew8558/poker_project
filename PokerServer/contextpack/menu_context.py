class MenuContext:
    ...
    def encoded(self):
        """ Get JSON-encoded version of Menu Context.
        ...
        enc_dict = {
            ...
            'change_login_status': self.change_login_status,
            'change_password_status': self.change_password_status,
            'tables_list': list(map(lambda t: t.encoded(), self.tables_list)),
            'connect_status': self.connect_status,
            'enter_stack': self.enter_stack
        }
        return enc_dict
